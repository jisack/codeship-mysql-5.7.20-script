...
# * MYSQL_PORT
#
MYSQL_VERSION=${MYSQL_VERSION:="5.7.20"}
...
mkdir -p "${MYSQL_DIR}"
wget --continue --output-document "${CACHED_DOWNLOAD}" "https://dev.mysql.com/get/Downloads/MySQL-5.7/mysql-${MYSQL_VERSION}-linux-glibc2.12-x86_64.tar.gz"
